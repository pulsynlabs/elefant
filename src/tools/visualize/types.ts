...
export type VizType = 'mermaid' | 'table' | 'stat-grid' | 'code' | 'research-card' | 'loading' | 'comparison'
...
export type ResearchCardPayload = Extract<VizPayload, { type: 'research-card' }>
